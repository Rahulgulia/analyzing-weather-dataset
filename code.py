...
weather = pd.DataFrame(weather_2012)
...
cat_var = categorical(weather)
num_var = numerical(weather)
...
checking = clear(weather,'Weather','Cloudy')
print(checking)
...
agg_values_ina_month(weather,'Date/Time','Temp (C)',len) 
